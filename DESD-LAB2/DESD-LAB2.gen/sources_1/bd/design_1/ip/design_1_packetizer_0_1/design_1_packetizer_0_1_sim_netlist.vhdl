...
--               c:/Users/chiar/Desktop/DESD-LAB2-ENCRYPTED.xpr/DESD-LAB2/DESD-LAB2.gen/sources_1/bd/design_1/ip/design_1_packetizer_0_1/design_1_packetizer_0_1_sim_netlist.vhdl
...
entity design_1_packetizer_0_1_packetizer is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_packetizer_0_1_packetizer : entity is "packetizer";
end design_1_packetizer_0_1_packetizer;

architecture STRUCTURE of design_1_packetizer_0_1_packetizer is
  ...
  signal s_axis_tready_int_i_2_n_0 : STD_LOGIC;
  signal state : STD_LOGIC_VECTOR ( 1 to 1 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \FSM_sequential_state[1]_i_1\ : label is "soft_lutpair0";
  attribute FSM_ENCODED_STATES : string;
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[0]\ : label is "idle:00,send_data:10,receive_data:01,send_footer:11";
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[1]\ : label is "idle:00,send_data:10,receive_data:01,send_footer:11";
  attribute SOFT_HLUTNM of \m_axis_tdata[0]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \m_axis_tdata[3]_i_2\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of m_axis_tvalid_int_i_1 : label is "soft_lutpair1";
begin
...
s_axis_tready_int_i_2: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
entity design_1_packetizer_0_1 is
  ...
  attribute NotValidForBitStream of design_1_packetizer_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_packetizer_0_1 : entity is "design_1_packetizer_0_1,packetizer,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_packetizer_0_1 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of design_1_packetizer_0_1 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of design_1_packetizer_0_1 : entity is "packetizer,Vivado 2020.2";
end design_1_packetizer_0_1;

architecture STRUCTURE of design_1_packetizer_0_1 is
...
begin
U0: entity work.design_1_packetizer_0_1_packetizer
     port map (
      aresetn => aresetn,
      clk => clk,
      m_axis_tdata(7 downto 0) => m_axis_tdata(7 downto 0),
